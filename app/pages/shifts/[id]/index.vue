    ...
    >
        ...
        <AppCard>
          <template #header>
            <AppButton
              size="sm"
              variant="outline"
              @click="router.push(`/shifts/${id}/edit`)"
            >
              Editar
            </AppButton>
          </template>
          <div class="space-y-3">
            ...
            <div class="flex justify-between text-sm items-center">
              ...
              <AppBadge :variant="statusVariant(shift.status)">
                {{ shift.status }}
              </AppBadge>
            </div>
            <div
      ...
      <AppCard title="Registros de ingresos">
        <template #header>
          <AppButton
            size="sm"
            variant="primary"
            @click="router.push('/income/create')"
          >
            + Agregar ingreso
          </AppButton>
        </template>
        <AppTable
          :columns="incomeCols"
          :rows="incomeList"
          empty-message="No hay ingresos para este turno."
        >
      ...
      <AppCard title="Registros de gastos">
        ...
        <AppTable
          :columns="expenseCols"
          :rows="expenseList"
          empty-message="No hay gastos para este turno."
        >
          <template #cell-date="{ row }">
            {{ formatDate(row.date) }}
          </template>
